...
<ImageCaption
  src="/post/react/react-server-components-이해하기/without-react-server-components-in-next-js.webp"
...
<ImageCaption
  src="/post/react/react-server-components-이해하기/with-react-server-components-in-next-js.webp"
