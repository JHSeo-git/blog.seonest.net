...
사용자가 앱에서 navigate할 때, 라우터는 인메모리 client-side 캐시에 React Server Component <SpicyText>payload</SpicyText>의 결과를 저장합니다.
...
#### Combining Intercepting and Parallel Routes Example
