...
`React.memo`는 최근 블로그인 [Why React Re-Renders](https://www.seonest.net/posts/Why-React-Re-Renders) 에 더 자세히 작성되어 있습니다.
...
아래 예시에서 `Boxex` 컴포넌트를 만들었습니다. 장식 용도로 나열된 색깔을 가진 box 모음을 보여줍니다.
