...
> [10 Must-Know Concepts of Modern Web Architecture](https://betterprogramming.pub/10-must-know-concepts-of-modern-web-architecture-9ecbefef8bc)
>
...
- ms azure - [Azure Virtual Machine](https://azure.microsoft.com/ko-kr/services/virtual-machines/)
...
> *- [load balancing*위키](https://ko.wikipedia.org/wiki/%EB%B6%80%ED%95%98%EB%B6%84%EC%82%B0)\_
...
> [kafka](https://kafka.apache.org/)라는 잘 알져진 시스템이 있습니다.
>
> AWS에서는 [SQS](https://aws.amazon.com/ko/sqs/) 라는 이름으로 제공합니다.
