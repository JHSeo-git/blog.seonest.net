...
폴리레포에서 작업할 때 위와 같은 꽤 까다로운 상황에 처할 수 있습니다. 그렇다고 해서 모노레포가 이 모든 문제를 해결하는데 도움이 될까요?
...
<IFrame src="https://www.youtube.com/embed/v87Y8NgAYLo?si=M9sQNPlEYn3L4Ize"></IFrame>
