...
thumbnail: '/post/web/ecmascript-2022/thumbnail.png'
update: '2023-03-26T13:37:49Z'
---

얼마 전 2022년 6월 22일에 ECMA International TC39는 ECMAScript 2022(EMCA-262 13판)를 승인했습니다.

JavaScript 표준과 명세를 담당하는 곳이 ECMA International(TC39)이고, [ECMA-262](https://tc39.es/ecma262/)라는 이름으로 발표됩니다.

다시 말해 JavaScript는 ECMA-262 명세서를 구현한 구현체라고 보면 됩니다. JavaScript 엔진(브라우저나 노드 등)에서 이와 같은 기능을 제공해주어야 사용할 수 있습니다.
...
private 필드와 관련이 있는 기능입니다. Class내에 필드가 private 필드인지 체크하는게 `try/catch`등을 이용해야 하고 그로 인해 복잡한 코드를 야기한다는 것이었습니다.
...
계속되는 새로운 문법과 기능들은 개발자들에게 편리함과 직관성을 제공하며, 한편으로는 끊임없이 배워야하는 부담감도 느끼게 합니다.
그러나 이러한 변화를 적극 수용하고 적용하면 개발 과정이 더욱 효율적이고 즐겁게 진행될 것입니다.

이미 대부분의 기능을 제공하고 있기 때문에, 트랜스파일러인 babel을 사용하지 않아도 될 수도 있습니다.

또는 TypeScript와의 문법 차이에 대한 혼동이 있을 수 있으므로 주의해야 합니다.

TC39 문서를 자세히 살펴보는 것은 언어 명세에 대한 부담감을 줄이기도 하고 흥미로운 제안을 볼 수 있는 시간이기도 했습니다. ECMAScript 2022에서 채택된 기능들을 활용하여 JavaScript 개발에 흥미를 더하는 것도 좋을 것 같습니다.
