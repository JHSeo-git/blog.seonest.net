...
![1](/post/javascript/javascript-how-it-works/engine.png)

### 작동원리

![v8-1](/post/javascript/javascript-how-it-works/v8.png)
...
![2](/post/javascript/javascript-how-it-works/js-engine-runtime.png)
...
![loop](/post/javascript/javascript-how-it-works/eventloop.png)

Node.js는 비동기 IO를 지원하기 위해 libuv 라이브러리를 사용하며, 이 libuv가 이벤트 루프를 제공합니다.
![nodejs](/post/javascript/javascript-how-it-works/nodejs.jpg)
...
![heap](/post/javascript/javascript-how-it-works/memoryheap.png)

### 콜 스택

콜 스택은 메모리에 존재하는 공간 중의 하나로, 코드를 읽어내려가면서 수행할 작업들을 밑에서부터 하나씩 쌓고, 메모리 힙에서 작업 수행에 필요한 것들을 찾아서 작업을 수행하는 공간입니다.

![stack](/post/javascript/javascript-how-it-works/callstack.png)
