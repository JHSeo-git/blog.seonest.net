...
<Callout title="Note">
  ...
  완벽하지 않습니다. React Compiler는 React 19 RC에 포함되어 있습니다. 만약 React 19로 업그레이드 할
  수 없다면, Working Group에서 설명된 cache function을 만들어서 사용할 수 있습니다. 그러나 이는
  추천되지는 않습니다. 가능하면 React 19로 업그레이드 하는 것이 좋습니다.
</Callout>
