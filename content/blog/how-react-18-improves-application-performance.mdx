...
![Flow of main thread at a browser](/post/react/how-react-18-improves-application-performance/process-of-main-thread.webp)
...
![A diagram of a long task](/post/react/how-react-18-improves-application-performance/long-task.webp)
...
![A diagram of Total Blocking Time](/post/react/how-react-18-improves-application-performance/total-blocking-time.webp)
...
> Core Web Vitals은 Google이 웹 페이지의 사용자 경험을 개선하고 웹 개발자들이 성능 최적화를 수행할 수 있도록 하기 위해 제안한 지표들로, 검색 엔진 최적화(SEO) 측면에서도 중요한 역할을 합니다. LCP, FID, CLS로 구성되어 있습니다.
> 최근에는 INP(Interaction to Next Paint)를 새로운 Core Web Vitals로 발표하면서 기존 FID(First Input Delay) 지표를 2024년 3월에 대체할 것이라고 발표했습니다.  
> Core Web Vitals에 대한 자세한 내용은 [이 블로그](https://web.dev/vitals/)와 제가 옮긴 [이 글](https://www.seonest.net/posts/web/%EC%9B%B9-%EC%82%AC%EC%9D%B4%ED%8A%B8-%EC%84%B1%EB%8A%A5-2-core-web-vitals-lcp) 도 참고하시면 좋습니다.

![A diagram of Interaction to Next Paint](/post/react/how-react-18-improves-application-performance/interaction-to-next-paint.webp)
...
![A diagram of a rendering phase in react](/post/react/how-react-18-improves-application-performance/rendering-phase-in-react.webp)
...
![A diagram of a synchronous rendering](/post/react/how-react-18-improves-application-performance/react-sync-rendering.webp)
...
![A screenshot of a browser performance tab for long tasks](/post/react/how-react-18-improves-application-performance/performance-tab-for-long-tasks.webp)
...
![A diagram of a concurrent rendering priorities](/post/react/how-react-18-improves-application-performance/react-18-concurrent-priority-diagram.webp)
...
![A diagram of a yield to main thread for prioriting component](/post/react/how-react-18-improves-application-performance/react-yield-to-main-thread.webp)
...
![A diagram of a concurrent rendering flow diagram](/post/react/how-react-18-improves-application-performance/react-concurrent-rendering-diagram.webp)
...
![A diagram of using a startTransition hook](/post/react/how-react-18-improves-application-performance/start-transition-hook.webp)
...
![A screenshot of the performance tab with the startTransition hook and without](/post/react/how-react-18-improves-application-performance/performance-tab-with-start-transition-hook.webp)
...
![A diagram of Client-Side Rendering and Server-Side Rendering](/post/react/how-react-18-improves-application-performance/client-side-rendering-and-server-side-rendering.webp)
...
![A diagram of React Server Components Rendering](/post/react/how-react-18-improves-application-performance/react-server-component.webp)
...
![A diagram of a shipping React Server Components and Client Components to client](/post/react/how-react-18-improves-application-performance/ship-rsc-and-client-components-to-client.webp)
...
![A diagram of processing a react suspense](/post/react/how-react-18-improves-application-performance/react-suspense.webp)
...
![A diagram of reprioritize rendering when user interact in rendering](/post/react/how-react-18-improves-application-performance/priority-for-user-interact-when-rendering.webp)
...
![A diagram of cache mechanism for data-fetch](/post/react/how-react-18-improves-application-performance/data-fetching-with-caching.webp)
