...
![react-app](/post/react/profiling-react-app/react-app.png)
...
![react-profiler-start](/post/react/profiling-react-app/react-profiler-start.png)

그런 뒤에 앱을 사용해보면서 프로파일링을 진행합니다. 그런 다음 "Stop profiling" 버튼(빨간색으로 변한)을 클릭합니다.

![react-profiler-stop](/post/react/profiling-react-app/react-profiler-stop.png)
...
![react-profiler-result](/post/react/profiling-react-app/react-profiler-result.png)
...
![react-profiler-prod-not-working](/post/react/profiling-react-app/react-profiler-prod-not-working.png)
...
![react-profiler-production-result](/post/react/profiling-react-app/react-profiler-production-result.png)
...
![performance-cpu-throttling](/post/react/profiling-react-app/performance-cpu-throttling.png)

|                            No Throttling                            |                            x6 Thottling                             |
| :-----------------------------------------------------------------: | :-----------------------------------------------------------------: |
| ![no-throttling](/post/react/profiling-react-app/no-throttling.png) | ![x6-throttling](/post/react/profiling-react-app/x6-throttling.png) |
