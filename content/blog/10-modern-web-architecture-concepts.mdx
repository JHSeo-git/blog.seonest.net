...
![aws-api-gateway](/post/web/10-modern-web-architecture-concepts/New-API-GW-Diagram.png)
...
![cloudfront-datacenter](/post/web/10-modern-web-architecture-concepts/Cloudfront-Map.png)

[CloudFlare](https://www.cloudflare.com/) data center locations

![cloudflare-datacenter](/post/web/10-modern-web-architecture-concepts/facebook-link-image.webp)
