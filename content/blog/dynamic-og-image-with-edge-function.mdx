...
![og-image-generator-deps](/post/javascript/dynamic-og-image-with-edge-function/og-image-generator-deps.png)
...
![5x-faster-performance](/post/javascript/dynamic-og-image-with-edge-function/5x-faster-performance.png)
...
![tw-image](/post/javascript/dynamic-og-image-with-edge-function/tw-image.png)
...
![first-image](/post/javascript/dynamic-og-image-with-edge-function/first-image.png)

![cache-image](/post/javascript/dynamic-og-image-with-edge-function/cache-image.png)

![headers](/post/javascript/dynamic-og-image-with-edge-function/headers.png)

![edge-location](/post/javascript/dynamic-og-image-with-edge-function/edge-location.png)
